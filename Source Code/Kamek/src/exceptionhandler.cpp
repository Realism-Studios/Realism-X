...
void PrintContext(u16 OSError, void *_osContext, u32 _dsisr, u32 _dar)
{
    ...
    nw4r::db::Exception_Printf_("Send this crash to https://discord.gg/ycRTYaYPu3.");
    #endif
    #ifndef RELEASECOMPILE
    nw4r::db::Exception_Printf_("Send this crash to https://discord.gg/ycRTYaYPu3.");
    #endif
    nw4r::db::Exception_Printf_("still not getting it", osContext->srr[0]);
    ...
    if (gprFun)
    {
        ...
        do
        {
            nw4r::db::Exception_Printf_("hi", i, osContext->gpr[i], i + 0xB, osContext->gpr[i + 0xB], i + 0x16, osContext->gpr[i + 0x16]);
            i++;
        } while (i < 10);
        nw4r::db::Exception_Printf_("hi", 10, osContext->gpr[10], 0x15, osContext->gpr[0x15]);
    }
