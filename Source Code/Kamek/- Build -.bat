...
:kamek
python tools/kamek.py NSMBWerProject.yaml --no-rels --use-mw --gcc-type=powerpc-eabi --gcc-path=C:\devkitPro\devkitPPC\bin --gcc-append-exe --mw-path=tools --fast-hack
